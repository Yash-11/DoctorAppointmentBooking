  ...
  return (
    <div>
      ...
      <div className='mx-auto px-4 py-4'>
        <div className="coainnt flex flex-col md:flex-row" >

          <div className="mt-4 ggg">
            <h2 className='h2heading text-4xl'>Find a Doctor</h2>
          ...
          <div className='mt-4 ggg '>
            <img className='image-container rounded-md' src="./homeimg.jpg" alt="MediLink Logo" />
          </div>
        ...
        <div className="mt-4 Carousel-container">
          <div>
            <h2 className='h2heading text-4xl mb-3'>What Our Patients Say</h2>
